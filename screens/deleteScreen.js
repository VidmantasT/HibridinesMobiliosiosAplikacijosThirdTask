...
import {showAll, deleteAdvertisement} from '../store/actions/actions';
                ...
                <ScrollView>
                    ...
                    {advertisements.advertisements.map((advertisement, index) => (
                        <View style={styles.deleteButton} key={index}>
                            <TouchableOpacity onPress={() => this.props.deleteAdvertisement(advertisement.id)}>
...
export default connect(mapStateToProps, {showAll, deleteAdvertisement})(deleteScreen);